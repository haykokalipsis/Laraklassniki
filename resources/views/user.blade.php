                ...
                <div class="text-center card-box">
                    <div class="member-card">
                        <div class="thumb-xl member-thumb m-b-10 center-block">
                            <img src="{{ $user->lastImage ? asset('img/users/' . $user->avatar->thumbnail_path ) : asset('img/defaults/avatars/male.png') }}"
                        ...
                        @if(auth()->id() !== $user->id)
                            <friend-component
                                    profile_user_id="{{ $user->id }}" auth_user_id="{{ auth()->id() }}">
                    ...
                    <!-- Friend request component END-->
                        ...
                        {{--                                        class="m-l-15">(123) 123 1234</span></p>--}}
                        {{--                            <p class="text-muted font-13"><strong>Email :</strong> <span class="m-l-15">johndoe@bootdey.com</span>--}}
                        {{--                            </p>--}}
                        {{--                            <p class="text-muted font-13"><strong>Location :</strong> <span class="m-l-15">USA</span>--}}
                        {{--                            </p>--}}
                        {{--                        </div>--}}
                    </div>
                </div> <!-- end card-box -->
